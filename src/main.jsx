...
function Loading(){return <main className="hero-surface"><section className="hero-layout single"><h1>Loading Sabbatical Explorations...</h1></section></main>}function useData(){const[data,setData]=useState(null);async function refresh(){const r=await loadPublicData();setData(r);return r}useEffect(()=>{refresh()},[]);return[data,refresh]}
    ...
    <div className="floating-ai-overlay">
      ...
      <section className="floating-ai-panel">
        <div className="floating-ai-head">
          <div>
            <p>Sabbatical Explorations COMPANION</p>
            ...
            <div className="floating-chat-messages">
              {messages.map(function(message,index){
                return (
                  ...
                  >
                    <span>
                      {message.role === 'user' ? 'You' : 'The Sabbatical Explorations Companion'}
                    </span>
              ...
              {busy && (
                <div className="chat-message chat-assistant">
                  <span>The Sabbatical Explorations Companion</span>
                  <p>{loadingMessage}</p>
                </div>
              )}
...
function LatestStory({data}) {
  ...
  return (
    <section className="story-section latest-story-section">
      <div className="section-inner latest-story-inner">
        ...
        <div>
          ...
          <p>
            {loc.summary ||
              'The next story from the journey will appear here.'}
          </p>
      ...
      {showSubscribe && (
        ...
        >
          ...
          >
            ...
            <p>
              Enter your email address and we will notify you
              whenever a new story is published.
            </p>
            ...
            <button
              type="button"
              className="newsletter-confirm-button"
              onClick={subscribe}
              disabled={busy}
            >
...
function Footer() {
  return (
    <footer className="footer">
      <span>Sabbatical Explorations</span>
